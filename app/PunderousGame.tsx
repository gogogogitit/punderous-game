  ...
  const loadDictionaryAndPuns = async () => {
    try {
      ...
      const punsData = [
        ...
        { id: 3, question: "What do you call a can opener that doesn't work?", answer: "A can't opener", difficulty: 1, upVotes: 0, downVotes: 0 },
        ...
        { id: 20, question: "Why did the gym get smaller and close down?", answer: "It didn't work out", difficulty: 2, upVotes: 0, downVotes: 0 },
        { id: 21, question: "Why did the cookie go to the doctor?", answer: "Because it was feeling crumbly", difficulty: 2, upVotes: 0, downVotes: 0 },
        ...
        { id: 46, question: "What does a nosy pepper do?", answer: "Gets jalapeño business", difficulty: 2, upVotes: 0, downVotes: 0 },
        ...
        { id: 57, question: "Why did the banana go to the doctor?", answer: "It wasn't peeling well", difficulty: 1, upVotes: 0, downVotes: 0 },
